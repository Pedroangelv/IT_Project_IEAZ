...
/** @type {string} */
const CACHE_VERSION = '1758645666|157583441';
/** @type {string} */
const CACHE_PREFIX = 'madrugon-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'madrugon.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["madrugon.html","madrugon.js","madrugon.offline.html","madrugon.icon.png","madrugon.apple-touch-icon.png","madrugon.audio.worklet.js","madrugon.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["madrugon.wasm","madrugon.pck"];
